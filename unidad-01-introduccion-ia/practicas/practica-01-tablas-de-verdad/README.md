...
Abre http://localhost:5101 en tu navegador. Mantén la terminal abierta;
Ctrl+C detiene el servidor. También puedes ejecutar `bash iniciar_practica_web.sh 1`
...
| Archivo | Función |
| --- | --- |
| `01_tablas_de_verdad.py` | Reglas de la práctica, validación y servidor Flask. |
...
ejecuta `01_tablas_de_verdad.py` con Python desde cualquier directorio.
