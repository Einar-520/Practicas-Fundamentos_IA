"""Práctica 3: exigir la lista oficial para presentar el examen."""
...
def main() -> None:
    ...
    lista_oficial = pedir_si_no("¿Aparece en la lista oficial? (si/no): ")

    resultado = puede_presentar_examen(
        asistencia, promedio, proyecto, adeudos, autorizacion, lista_oficial
    )
    if resultado:
        ...
        if not lista_oficial:
            print("Motivo: El alumno NO aparece en la lista oficial.")
